...
run_iv_tb "neuron_core"     "${RTL}/neuron_core.sv"     "${TB}/neuron_core_tb.v"
run_iv_tb "synapse_memory"  "${RTL}/synapse_memory.sv"  "${TB}/synapse_memory_tb.v"
run_iv_tb "spike_router"    "${RTL}/spike_router.sv"    "${TB}/spike_router_tb.v"
run_iv_tb "event_encoder"   "${RTL}/event_encoder.sv"   "${TB}/event_encoder_tb.v"
run_iv_tb "learning_engine" "${RTL}/learning_engine.sv" "${TB}/learning_engine_tb.v"
