...
[![Power](https://img.shields.io/badge/power-optimised-orange)](#key-results)
...
> Numbers from Vivado 2025.2 post-route on `xc7a100tcsg324-1`, 100 MHz.  
> Utilisation and power figures reflect v2.1.0 (NUM_SYNAPSES=512). v2.2.0 reduces BRAM count and estimated dynamic power; re-run `make synth` for updated reports.

| Metric | v2.1.0 (measured) | v2.2.0 (estimated) |
|--------|-------------------|--------------------|
| Clock | 100 MHz | 100 MHz |
| WNS | **+0.248 ns** ✅ | ≥ +0.3 ns (more slack with smaller BRAM) |
| WHS | **+0.061 ns** ✅ | similar |
| Slice LUTs | 21,570 (34.02%) | ~18,000–19,000 |
| Slice FFs | 8,375 (6.60%) | ~7,000–7,500 |
| Block RAM Tiles | 32 × RAMB36E1 | **8 × RAMB36E1** (128 syn/neuron) |
| DSPs | 0 | 0 |
| Dynamic Power | 448 mW | ~120–160 mW (activity-gated) |
| Static Power | 100 mW | 100 mW |
| DRC errors | 0 | 0 |
...
- [ ] SAIF-based power measurement — annotate simulation toggles into Vivado `report_power` for accurate v2.2.0 power figure
