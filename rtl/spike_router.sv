// ============================================================
// Module:      spike_router
// Description: X-then-Y DOR mesh NoC spike router.
//
// Change log:
//   v1.0 — initial release
//   v1.1 — MUXF7/F8 overflow fix
//   v1.2 — BUG-5 fix: credit net-delta; BUG-6 fix: per-port arbitration
//   v2.0 — Converted to SystemVerilog (.sv)
//   v2.1 — Port bundles replaced with noc_port interface (noc_port.sv).
//           Each direction has in_X (receiver_mp) + out_X (sender_mp).
//           Routing and arbitration logic unchanged.
//
// Author:   NeuraEdge / Rahul Verma | Version: 2.1.0 | Apache 2.0
// ============================================================
`timescale 1ns / 1ps
