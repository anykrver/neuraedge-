...
void reset_dut(Vlearning_engine* dut, VerilatedVcdC* vcd) {
    dut->rst_n        = 0;
    dut->spikes_valid = 0; dut->clk_en = 1;
    dut->pre_spike    = 0;
    dut->post_spike   = 0;
...
void send_spikes(Vlearning_engine* dut, VerilatedVcdC* vcd,
    ...
    dut->pre_spike    = pre;
    dut->post_spike   = post;
    dut->spikes_valid = 1; dut->clk_en = 1;
    tick_mem(dut, vcd);
    dut->spikes_valid = 0; dut->clk_en = 1;
    dut->pre_spike    = 0;
    dut->post_spike   = 0;
